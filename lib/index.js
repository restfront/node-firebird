...
const
    ...
    ISOLATION_READ                      = [isc_tpb_version3, isc_tpb_read, isc_tpb_read_committed, isc_tpb_rec_version];                    // read, read_committed, rec_version
    ISOLATION_WRITE                     = [isc_tpb_version3, isc_tpb_write, isc_tpb_nowait, isc_tpb_read_committed, isc_tpb_rec_version];   // write, nowait, read_committed, rec_version
...
exports.ISOLATION_READ = ISOLATION_READ;
exports.ISOLATION_WRITE = ISOLATION_WRITE;
